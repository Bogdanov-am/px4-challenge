...
from geometry_msgs.msg import PoseStamped, Point, TransformStamped, Vector3
...
class PosePublisher(Node):
    ...
    def cmdloop_callback(self):
        ...
        t.header.stamp = vehicle_pose_msg.header.stamp
        t.transform.rotation = vehicle_pose_msg.pose.orientation
        translation = Vector3()
        translation.x = vehicle_pose_msg.pose.position.x
        translation.y = vehicle_pose_msg.pose.position.y
        translation.z = vehicle_pose_msg.pose.position.z
